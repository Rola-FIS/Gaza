...
export default function FamilyCar(){
    ...
    return(
        <div className='  '>
            ...
            <div className='mt-0 ml-5 mr-5 p-6 pb-0 '>
                <h2 className='text-lg text-gray-700 font-bold'>Family Care </h2>
